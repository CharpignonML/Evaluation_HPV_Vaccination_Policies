...
df_snds <- read.csv2("/Users/charlottederogis/Desktop/Stage/données\ SNDS/vente\ par\ mois.csv")

df_snds$Date <- as.Date(paste0("01-", df_snds$Date), format = "%d-%m-%y")
...
ggplot(df_snds, aes(x = Date, y = n)) +
  ...
  ggtitle("Evolution of HPV vaccine dispensing")
