...
df <- read.csv2("/Users/charlottederogis/Desktop/Stage/R/Discontinuité\ gt/16122019.csv")
...
post <- df[df$Date >= as.Date("2019-12-16"), ]
post$t          <- post$Date -  as.Date("2019-12-16")
