...
df <- read.csv2("/Users/charlottederogis/Desktop/Stage/R/discontinuités/googletrends/02102023bis.csv")
df$Date <- as.Date(df$Date)
df$n <- as.numeric(df$n)
t0 <- as.Date("2023-10-02")
...
post <- df[df$Date >= as.Date("2023-10-02"), ]
post$t          <- post$Date -  as.Date("2023-10-02")
